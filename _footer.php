    ...
    <div id="quickview" class="quickview-wrapper" data-pages="quickview">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane fade  no-padding" id="quickview-alerts">
          <div class="view-port clearfix active" id="alerts">
            <!-- BEGIN Alerts View !-->
                  ...
                  <ul>
                    ...
                    <li class="alert-list">
                      ...
                      <a href="javascript:;" class="" data-navigate="view" data-view-port="#chat" data-view-animation="push-parrallax">
                        ...
                        <p class="p-l-10 col-xs-height col-middle col-xs-9 overflow-ellipsis fs-12">
                          <span class="text-master">Hora da Cartilha</span>
                        </p>
                        <p class="p-r-10 col-xs-height col-middle fs-12 text-right">
                          <span class="text-warning">Hoje <br></span>
                          <span class="text-master">18h</span>
                        </p>
                      </a>
                      <!-- END Alert Item!-->
                      <!-- BEGIN List Group Item!-->
                    ...
                    <li class="alert-list">
                      ...
                      <a href="#" class="" data-navigate="view" data-view-port="#chat" data-view-animation="push-parrallax">
                        ...
                        <p class="p-l-10 col-xs-height col-middle col-xs-9 overflow-ellipsis fs-12">
                          <span class="text-master">Pesquisa opinião Diária</span>
                        </p>
                        <p class="p-r-10 col-xs-height col-middle fs-12 text-right">
                          <span class="text-warning">Hoje <br></span>
                          <span class="text-master">12h</span>
                        </p>
                      </a>
                      <!-- END Alert Item!-->
                    </li>
        ...
        <!-- END Alerts !-->
        <div class="tab-pane fade active in no-padding" id="quickview-chat">
        ...
        <div class="view bg-white">
          <div class="scrollable">
            ...
            <div class="p-t-15">
              ...
              <div class="form-group-attached">
                <div class="form-group form-group-default ">
                  ...
                  <input type="text" class="form-control" id="txtEventName" name="" placeholder="Atividade">
                </div>
                <div class="row clearfix">
                  <div class="col-sm-9">
                    <div class="form-group form-group-default">
                      <label>Local</label>
                      <input type="text" class="form-control" id="txtEventLocation" placeholder="local" name="">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group form-group-default">
                ...
                <div class="row clearfix">
                  <div class="form-group form-group-default">
                    ...
                    <textarea class="form-control" placeholder="Descrição" id="txtEventDesc"></textarea>
                  </div>
                </div>
            ...
            <div class="p-l-30 p-r-30 p-t-30">
              <button id="eventSave" class="btn btn-warning btn-cons">Salvar</button>
        ...
        <div class="view bg-white">
          <div class="navbar navbar-default navbar-sm">
            <div class="navbar-inner">
              ...
              <div class="view-heading">
                <span class="font-montserrat text-uppercase fs-13">Alertas</span>
              </div>
              <a href="#" class="inline action p-r-10 pull-right link text-master">
                <i class="pg-search"></i>
              </a>
          ...
          <p class="p-l-30 p-r-30 p-t-30"> Avisar resposável após concluído</p>
        </div>
      </div>
    </div>
